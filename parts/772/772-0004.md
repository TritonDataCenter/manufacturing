# Joyent p/n 772-0004-01 (JCP 1200 firmware configuration, SDC 7)
...
^			Package C State limit: C2
	...
	SATA Configuration
		SATA Mode: AHCI Mode
		Aggressive Link Power Manage: Enabled
		Port 0 Hot Plug: Enabled
		Port 1 Hot Plug: Enabled
		Port 2 Hot Plug: Enabled
		Port 3 Hot Plug: Enabled
		Port 4 Hot Plug: Enabled
		Port 5 Hot Plug: Enabled
		Port 0 Staggered Spin-up: Disabled
...
^			Redirection After BIOS POST: Until Bootloader
		Serial Port for OOBM/Windows Console Redirection: Disabled
